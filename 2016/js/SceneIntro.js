...
var SceneIntro = (function (_super) {
    ...
    SceneIntro.prototype.init = function () {
        ...
        this.rect2.on("mouseover", function (event) {
            callIn();
        });
        this.rect2.on("mouseout", function (event) {
            callOut();
        });
        var THIS = this;
        function callIn() {
        ...
        this.rect2.on("click", function (event) {
    ...
    SceneIntro.prototype.startScene = function () {
    ...
    SceneIntro.prototype.getStopSceneTime = function () {
        return 43 / 12;
    };
    SceneIntro.prototype.stopScene = function () {
