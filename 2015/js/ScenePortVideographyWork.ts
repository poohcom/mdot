...
class ScenePortVideographyWork extends ScenePortWork {
    ...
    public setIndex(idx: number) {
        ...
        this.bigimgButton.on("mouseover", function () {
            ScenePortVideographyWork.instance().bigimgButton.setVisible(); ScenePortVideographyWork.instance().icon_play.visible = true;
        ...
        this.bigimgButton.on("mouseout", function () {
            ScenePortVideographyWork.instance().bigimgButton.setInvisible(); ScenePortVideographyWork.instance().icon_play.visible = false;
    ...
    public setType(): void
    {
        switch (this.getlayout())
        {
            case 1:
                ...
                //this.bigimg.x = 425;
                //this.bigimg.y = 168;
                //this.bigimgButton.x = 425;
                //this.bigimgButton.y = 168;
