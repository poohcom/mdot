...
class SceneSideMenu extends Scene {
    private static _instance: SceneSideMenu = null;
    public static instance(): SceneSideMenu {
    ...
    public titleBitmap: createjs.Bitmap=null;
    
    public portfolio_button: Button;

    public portfolioGroup: createjs.Container;

    private title: createjs.Bitmap = null;
    public setSceneMode(index: number): void {
    ...
    public mouseover_interactive_design: SideButton;
    public mouseover_animation: SideButton;
    public mouseover_videography: SideButton;
    public mouseover_contents: SideButton;
    public mouseover_poster: SideButton;
    ...
    public init(): void {
        ...
        this.portfolio_button.on("click", function (event: createjs.MouseEvent) {
    ...
    public sideButtonInit(index:number) {

        var targetRad: number = 130;
        var delay: number = 1000;
        for (var i: number = 0; i < this.sideButton.length; i++) {
            var sideButton: SideButton = this.sideButton[i];
    ...
    public drawLines(): void {
        ...
        if (this.mode == 1) {
            ...
            for (var j: number = 0; j < this.sideButton.length; j++) {
                var sideButton: SideButton = this.sideButton[j];
