...
class ScenePortAnimationWork extends ScenePortWork {
    ...
    public setIndex(idx: number) {
        ...
        this.bigimgButton.on("mouseover", function () {
            ScenePortAnimationWork.instance().bigimgButton.setVisible(); ScenePortAnimationWork.instance().icon_play.visible = true;
        ...
        this.bigimgButton.on("mouseout", function () {
            ScenePortAnimationWork.instance().bigimgButton.setInvisible(); ScenePortAnimationWork.instance().icon_play.visible = false;
        ...
        this.bigimgButton.on("click", function () { ScenePortAnimationWork.instance().bigimgButton.setInvisible(); ScenePortAnimationWork.instance().icon_play.visible = false; ScenePortAnimationWork.instance().playVideo(); SceneManager.instance().bgmOff(); });
