...
var MenuBar = (function (_super) {
    ...
    MenuBar.prototype.init = function () {
        ...
        this.main_scroll_page1_button.on("click", function () {
            SceneManager.instance().nextSceneIndex(0);
        });
        this.main_scroll_page1_button.on("mouseover", function () {
            MenuBar.instance().mouseOverMain(1);
        });
        this.main_scroll_page1_button.on("mouseout", function () {
            MenuBar.instance().mouseOutMain(1);
        });
        ...
        this.main_scroll_page2_button.on("click", function () {
            SceneManager.instance().nextSceneIndex(1);
        });
        this.main_scroll_page2_button.on("mouseover", function () {
            MenuBar.instance().mouseOverMain(2);
        });
        this.main_scroll_page2_button.on("mouseout", function () {
            MenuBar.instance().mouseOutMain(2);
        });
        ...
        this.main_scroll_page3_button.on("click", function () {
            SceneManager.instance().nextSceneIndex(2);
        });
        this.main_scroll_page3_button.on("mouseover", function () {
            MenuBar.instance().mouseOverMain(3);
        });
        this.main_scroll_page3_button.on("mouseout", function () {
            MenuBar.instance().mouseOutMain(3);
        });
        ...
        this.up_button.on("click", function () {
            MenuBar.instance().goUp();
        });
        ...
        this.down_button.on("click", function () {
            MenuBar.instance().goDown();
        });
        ...
        this.under_bar.on("mouseover", function () {
        ...
        this.about_button1.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(10);
        });
        this.about_button1.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(1);
        });
        this.about_button1.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(1);
        });
        ...
        this.about_button2.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(11);
        });
        this.about_button2.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(2);
        });
        this.about_button2.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(2);
        });
        ...
        this.about_button3.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(12);
        });
        this.about_button3.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(3);
        });
        this.about_button3.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(3);
        });
        ...
        this.about_button4.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(13);
        });
        this.about_button4.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(4);
        });
        this.about_button4.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(4);
        });
        ...
        this.about_button5.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(14);
        });
        this.about_button5.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(5);
        });
        this.about_button5.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(5);
        });
        ...
        this.about_button6.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(15);
        });
        this.about_button6.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(6);
        });
        this.about_button6.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(6);
        });
        ...
        this.about_button7.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(16);
        });
        this.about_button7.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(7);
        });
        this.about_button7.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(7);
        });
        ...
        this.about_button8.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(17);
        });
        this.about_button8.on("mouseover", function () {
            MenuBar.instance().mouseOverAbout(8);
        });
        this.about_button8.on("mouseout", function () {
            MenuBar.instance().mouseOutAbout(8);
        });
        ...
        this.button_back.on("mouseover", function (event) {
            MenuBar.instance().showIcon();
        });
        this.button_back.on("mouseout", function (event) {
            MenuBar.instance().hideIcon();
        });
        ...
        this.work_page_button_back.on("mouseover", function (event) {
            MenuBar.instance().showWorkIcon();
        });
        this.work_page_button_back.on("mouseout", function (event) {
            MenuBar.instance().hideWorkIcon();
        });
        this.work_page_button_back.on("click", function (event) {
            SceneManager.instance().nextSceneIndex(2);
        });
        this.work_back_button_Group.addChild(this.work_page_button_back);
    ...
    MenuBar.prototype.mouseOverMain = function (index) {
        SceneManager.instance().soundplay();
    ...
    MenuBar.prototype.mouseOutMain = function (index) {
        if (this.mainIndex == index)
            return;
        if (index == 1) {
            createjs.Tween.removeTweens(this.main_scroll_page1_text);
    ...
    MenuBar.prototype.mouseOverAbout = function (index) {
        SceneManager.instance().soundplay();
    ...
    MenuBar.prototype.mouseOutAbout = function (index) {
        if (this.aboutIndex == index)
            return;
        var text = null;
        switch (index) {
    ...
    MenuBar.prototype.showIcon = function () {
        this.button_back_portfolio.visible = true;
    };
    MenuBar.prototype.hideIcon = function () {
        this.button_back_portfolio.visible = false;
    };
    MenuBar.prototype.showWorkIcon = function () {
        this.work_page_button_back_portfolio.visible = true;
    };
    MenuBar.prototype.hideWorkIcon = function () {
        this.work_page_button_back_portfolio.visible = false;
    };
    MenuBar.prototype.goUp = function () {
    ...
    MenuBar.prototype.goDown = function () {
        switch (SceneManager.instance().getSceneIndex()) {
            case 0:
                SceneManager.instance().nextSceneIndex(1);
                break;
    ...
    MenuBar.prototype.updateIndex = function () {
    ...
    MenuBar.prototype.setMode = function (mode) {
        this.button_back_portfolio.visible = false;
        this.work_page_button_back_portfolio.visible = false;
        switch (mode) {
            case 0:
    ...
    MenuBar.prototype.showAboutBar = function () {
    ...
    MenuBar.prototype.hideAboutBar = function () {
        createjs.Tween.removeTweens(this.under_bar);
        createjs.Tween.removeTweens(this.underbar_gard_aboutmediadesign);
