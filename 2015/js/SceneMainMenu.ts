...
class SceneMainMenu extends Scene { 
    private static _instance: SceneMainMenu = null;
    public static instance(): SceneMainMenu {
    ...
    public contents_design_button: CircleButton;
    public animation_button: CircleButton;
    public videography_button: CircleButton;
    public interactive_button: CircleButton;
    public poster_button: CircleButton;

    public aboutGroup: createjs.Container;
    public portfolioGroup: createjs.Container;

    public main_portfolio_copyrights: createjs.Bitmap;
    /////////////////////
    //public circle_1: createjs.Bitmap;
    public circle_2: createjs.Bitmap;
    public circle_3: createjs.Bitmap;
    public circle_4: createjs.Bitmap;
    public circle_5: createjs.Bitmap;

    public circle_4_mask: CircleMask;

    public menu_portfolio: createjs.Bitmap;
    public center_text: createjs.Bitmap;

    public line: CircleLine;

    public setCenterText(index:number): void {
    ...
    public init(): void {
        ...
        this.interactive_button.on("click", function (event: createjs.MouseEvent) {
        ...
        this.animation_button.on("click", function (event: createjs.MouseEvent) {
            createjs.Sound.play("portfolio_menu_open", createjs.Sound.INTERRUPT_ANY, 0, 0, 0, 0.5);
        ...
        this.videography_button.on("click", function (event: createjs.MouseEvent) {
            createjs.Sound.play("portfolio_menu_open", createjs.Sound.INTERRUPT_ANY, 0, 0, 0, 0.5);
        ...
        this.contents_design_button.on("click", function (event: createjs.MouseEvent) {
            createjs.Sound.play("portfolio_menu_open", createjs.Sound.INTERRUPT_ANY, 0, 0, 0, 0.5);
        ...
        this.poster_button.on("click", function (event: createjs.MouseEvent) {
            createjs.Sound.play("portfolio_menu_open", createjs.Sound.INTERRUPT_ANY, 0, 0, 0, 0.5);
    ...
    private setCirclePosition(button: createjs.DisplayObject, rad: number, r:number): void {
    ...
    public drawLines(): void {
        ...
        var target: number = Math.min(240,-120 + this.count * 8);
