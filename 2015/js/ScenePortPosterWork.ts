...
class ScenePortPosterWork extends ScenePortWork {
    ...
    public setIndex(idx: number) {
        ...
        this.bigimgButton.on("mouseover", function () {
            ScenePortPosterWork.instance().bigimgButton.setVisible(); ScenePortPosterWork.instance().icon_play.visible = true;
        ...
        this.bigimgButton.on("mouseout", function () {
            ScenePortPosterWork.instance().bigimgButton.setInvisible(); ScenePortPosterWork.instance().icon_play.visible = false;
        ...
        this.bigimgButton.on("click", function () { ScenePortPosterWork.instance().bigimgButton.setInvisible();ScenePortPosterWork.instance().icon_play.visible = false; ScenePortPosterWork.instance().popup2(ScenePortPosterWork.instance().getlayout(), "assets/16th_web/poster/big/", 1, 1) });
