...
class SceneManager {
    ...
    public bgstage: createjs.Stage = null;
    ...
    private sceneMain: SceneMain = null;
    public scene: Scene=null;
    
    private message: createjs.Text = null;
    private bgImage1: createjs.Bitmap = null;
    private bgImage2: createjs.Bitmap = null;
    private loadProgressLabel: createjs.Text = null;
    private timerAlpha: number;


    private whitebg: createjs.Shape;
    ...
    public queueBG: createjs.LoadQueue;
    ...
    public preload(applyshader: Function, applyScene: Function): void {
    ...
    public preload2(applyshader: Function): void {
        ...
        function handleFileLoad(event) {
            ...
            if (SceneManager.instance().isLoadedData == true) {
                ...
                if (SceneManager.instance().bgm === null) {
                    ...
                    //SceneManager.instance().bgm = createjs.Sound.play("mouse_over", createjs.Sound.INTERRUPT_ANY, 0, 0, -1);
        ...
        this.queue.loadManifest([
            ...
            //SceneSideMenu
            //{ id:"menu_work_about_media_design", src: "assets/main/menu_work/about_media_design.png"},
            //{ id: "menu_work_circle", src: "assets/main/menu_work/circle.png" },
            //{ id: "menu_work_portfolio", src: "assets/main/menu_work/portfolio.png" },
            //{ id:"circle_aboutmdiadesign_2", src: "assets/main/menu_work/circle_aboutmdiadesign_2.png"},
            //{ id:"circle_aboutmediadesign_1", src: "assets/main/menu_work/circle_aboutmediadesign_1.png"},
            //{ id:"mouseover_16thmdot", src: "assets/main/menu_work/mouseover_16thmdot.png"},
            //{ id:"mouseover_about_media_design", src: "assets/main/menu_work/mouseover_about_media_design.png"},
            //{ id:"mouseover_animation", src: "assets/main/menu_work/mouseover_animation.png"},
            //{ id:"mouseover_contents", src: "assets/main/menu_work/mouseover_contents.png"},
            //{ id:"mouseover_interactive_design", src: "assets/main/menu_work/mouseover_interactive_design.png"},
            //{ id:"mouseover_poster", src: "assets/main/menu_work/mouseover_poster.png"},
            //{ id:"mouseover_professors", src: "assets/main/menu_work/mouseover_professors.png"},
            //{ id:"mouseover_students", src: "assets/main/menu_work/mouseover_students.png"},
            //{ id:"mouseover_videography", src: "assets/main/menu_work/mouseover_videography.png"},
        ...
        function handleProgress() {
            ...
            var progresPrecentage: number = Math.round(this.queue.progress * 100);
            this.g.clear();
            ...
            var msg: string = progresPrecentage + "%";
    ...
    public darkBG: createjs.Shape=null;
    public darkBGMask: createjs.Shape = null;
    ...
    public setSize(w: number, h: number): void
    {
        ...
        if (1920 / 1080 > w / h)
        {
            ...
            this.darkBGMask.graphics.beginFill("#FFF").drawRect(0, 0, w,(h - 1080 * w / 1920) / 2).drawRect(0,(h - 1080 * w / 1920) / 2 + 1080 * w / 1920, w, h - (h - 1080 * w / 1920) / 2 + 1080 * w / 1920);
            //this.darkBGMask.graphics.beginFill("#000").drawRect(0,(h - 1080 * w / 1920) / 2 + 1080 * w / 1920, w, h - (h - 1080 * w / 1920) / 2 + 1080 * w / 1920);
            ...
            this.darkBGMask.graphics.beginFill("#FFF").drawRect(0, 0,(w - 1920 * h / 1080) / 2, h).drawRect((w - 1920 * h / 1080) / 2 + 1920 * h / 1080, 0, w - ((w - 1920 * h / 1080) / 2 + 1920 * h / 1080), h);
            //this.darkBGMask.graphics.beginFill("#000").drawRect((w - 1920 * h / 1080) / 2 + 1920 * h / 1080, 0, w - ((w - 1920 * h / 1080) / 2 + 1920 * h / 1080), h);
        ...
        (<HTMLCanvasElement>document.getElementById('bgcanvas')).width = w;
        (<HTMLCanvasElement>document.getElementById('bgcanvas')).height = h;
    ...
    public fadeInStart(): void
    {
        this.bgContainer.removeAllChildren();
        this.bgImage1 = new createjs.Bitmap(<HTMLImageElement> this.queueBG.getResult(this.bgList[this.oldIndex]));
        this.bgImage1.alpha = 1;
        this.bgImage2 = new createjs.Bitmap(<HTMLImageElement> this.queueBG.getResult(this.bgList[this._sceneIndex]));
        ...
        this.timerAlpha = setInterval(() => this.fadeIn(), 50);
    }
    ...
    public popup_index: number = 0;
    public isPoup:Boolean = false;
    ...
    public closeSitemap(index: number): void {
        this.isPoup = false;
        this.sceneContainer.visible = true;
        this.menuContainer.removeChild(SceneSitemap.instance())
    ...
    public port_index: number = 0;

    public popupPort(index: number, page_index:number): void {
        if (this.isPlaying == true)
            return;
    ...
    private bgList: string[] = [
        ...
        "about_media_design_background", // about 10
        "about_media_design_background", // professor 11
        "about_media_design_background", // 3_students 12
        "about_media_design_background", // 16th m.dot 13
        "about_media_design_background", // 16th committee 14
        "about_media_design_background", // 16th Design process1 15
        "about_media_design_background", // 16th Design process2 16
        "about_media_design_background", // 16th Design process3 17
        "about_media_design_background", // 18
        "about_media_design_background", // 19

        "interactive_design_background", // 20 in
        "animation_background", // 21 ani
        "vediography_background", // 22 vide
        "contents_design_background", // 23 contents
        "poster_background", // 24 poster

        "interactive_design_background", // 25
        "animation_background", // 26
        "vediography_background", // 27
        "contents_design_background", // 28
        "poster_background", // 29
    ];
    ...
    public nextSceneIndex(index: number): void {
        //if (this.isPoup == true) {
            //return;
        //}
        ...
        if (this.scene === null) {
            ...
            if (index >= 10 && index < 19 &&
                this._sceneIndex >= 10 && this._sceneIndex <= 19) {
            } else {
                setTimeout(function () { SceneManager.instance().sceneContainer.removeChild(s) }, 1000);
            }
