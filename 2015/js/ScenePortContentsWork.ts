...
class ScenePortContentsWork extends ScenePortWork {

    private static _instance: ScenePortContentsWork = null;
    ...
    public static instance(): ScenePortContentsWork {
    ...
    public setIndex(idx: number) {
        ...
        this.bigimgButton.on("mouseover", function () {
            ScenePortContentsWork.instance().bigimgButton.setVisible(); ScenePortContentsWork.instance().icon_play.visible = true;
        ...
        this.bigimgButton.on("mouseout", function () {
            ScenePortContentsWork.instance().bigimgButton.setInvisible(); ScenePortContentsWork.instance().icon_play.visible = false;
        ...
        this.bigimgButton.on("click", function () { ScenePortContentsWork.instance().bigimgButton.setInvisible(); ScenePortContentsWork.instance().icon_play.visible = false; ScenePortContentsWork.instance().popup(ScenePortContentsWork.instance().getlayout(), "assets/16th_web/contents/big/", ScenePortContentsWork.instance().imgIndex, 4) });
