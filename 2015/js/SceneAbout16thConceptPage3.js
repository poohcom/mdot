...
var SceneAbout16thConceptPage3 = (function (_super) {
    __extends(SceneAbout16thConceptPage3, _super);
    function SceneAbout16thConceptPage3() {
        _super.call(this);
        this.isCircle = false;
        this.circleX = 0;
        this.circleY = 0;
        this.circlePosX = [556, 903, 1225, 556, 903, 1225];
        this.circlePosY = [442, 442, 442, 669, 669, 669];
    ...
    SceneAbout16thConceptPage3.instance = function () {
    ...
    SceneAbout16thConceptPage3.prototype.init = function () {
        this.initBubble();
    ...
    SceneAbout16thConceptPage3.prototype.onCircleStart = function (event) {
        SceneAbout16thConceptPage3.instance().isCircle = true;
        SceneAbout16thConceptPage3.instance().circleX = event.target.x;
        SceneAbout16thConceptPage3.instance().circleY = event.target.y;
        SceneAbout16thConceptPage3.instance().initGraphic();
    };
    SceneAbout16thConceptPage3.prototype.onCircleStop = function (event) {
        SceneAbout16thConceptPage3.instance().isCircle = false;
        SceneAbout16thConceptPage3.instance().clearGraphic();
    };
    SceneAbout16thConceptPage3.prototype.startScene = function () {
        this.count = 0;
        this.alpha = 0;
    ...
    SceneAbout16thConceptPage3.prototype.stopScene = function () {
    ...
    SceneAbout16thConceptPage3.prototype.drawing = function (event) {
        event.target.drawLines();
    };
    SceneAbout16thConceptPage3.prototype.drawLines = function () {
        this.count++;
        this.updateBubble();
    ...
    SceneAbout16thConceptPage3.prototype.initBubble = function () {
        for (var i = 0; i < 6; i++) {
            for (var j = 0; j < 5; j++) {
    ...
    SceneAbout16thConceptPage3.prototype.updateBubble = function () {
    ...
    SceneAbout16thConceptPage3.prototype.initGraphic = function () {
    ...
    SceneAbout16thConceptPage3.prototype.clearGraphic = function () {
        for (var i = 0; i < this.shapeList.length; i++) {
            this.removeChild(this.shapeList[i]);
        }
        this.shapeList = [];
    };
    SceneAbout16thConceptPage3._instance = null;
    return SceneAbout16thConceptPage3;
})(Scene);
//# sourceMappingURL=SceneAbout16thConceptPage3.js.map